...
│── RootLength_Detection.ipynb # end-to-end notebook
│── src/
│ ├── task_8_helpers.py # helper functions (f1, crop_to_petri_dish, etc.)
│── models/
│ └── SalopMaria_230574_unet_model_128px.h5 # trained U-Net model
│── data/
│ ├── images/ # input images (not shared)
│ ├── masks/ # model outputs (18 masks)
│ └── divided_masks/ # masks split into 5 plants (90 total)
│── results/
│ ├── primary_root_lengths_v2.csv # root length outputs
│── presentation/
│ └── RootLength_Project_Presentation.pdf # project slides
